...
We have to program a function that substracts numbers contained in the array as well as create a unit test for that function and calculate the test coverage.
